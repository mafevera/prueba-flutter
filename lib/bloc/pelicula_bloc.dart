...
class PeliculasBloc {
  ...
  final _popularesStreamController = StreamController<List<Pelicula>>.broadcast();// para que muchas personas puedan escucharlo;
  ...
  final _recomendadasStreamController = StreamController<List<Pelicula>>.broadcast();// para que muchas personas puedan escucharlo;


  Function(List<Pelicula>) get recomendadasSink => _recomendadasStreamController.sink.add;

  Stream<List<Pelicula>> get recomendadasStream => _recomendadasStreamController.stream;
